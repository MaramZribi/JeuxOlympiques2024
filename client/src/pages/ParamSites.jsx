...
export default function ParamSites() {
    ...
    useEffect(() => {
        const fetchSites = async () => {
            try {
                const response = await axios.get('/paralympic-sites');
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold mb-4 text-center">Sites paralympiques</h1>
            <SearchBarS />
